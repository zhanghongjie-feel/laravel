...
<head>
	...
	<link rel="shortcut icon" href="/mstore/img/favicon.123.jpg">
...
<body>
	...
	<div class="side-nav-panel-right">
		<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
			<li class="profil">
				<img src="/mstore/img/123.jpg" alt="">
				<h2>John Doe</h2>
			</li>
			...
			<div class="row">
				<div class="col s6">
					<div class="content">
						...
						<button class="btn button-default addCart" goods_id="{{$v->goods_id}}">添加购物车</button>
...
<script>
	$(function(){
		$('.addCart').click(function(){
			...
			// alert(id);
			location.href="{{url('home/add_cart')}}?id="+id;
		});
	});
</script>